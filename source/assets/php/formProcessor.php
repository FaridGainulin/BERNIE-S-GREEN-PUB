...
// Create mail data
$headers = 'From: «BERNIES GREEN PUB» <info@mysite.ru>' . "\r\n";
...
$subject = 'Заявка с лендинга «BERNIES GREEN PUB»';

$phone = '';
$nameOrCity = '';
$htmlBody = "<html><body style='font-family:Arial,sans-serif;'5>";
$htmlBody .=
    "<h2 style='font-weight:bold;border-bottom:1px dotted #ccc;'>Заявка с лендинга «BERNIES GREEN PUB»</h2>\r\n";
...
if (mail($sendto, $subject, $htmlBody, $headers)) {
    if (
        ...
        $customerSubject = 'Вы подали заявку на лендинге «BERNIES GREEN PUB»';
